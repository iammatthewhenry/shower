...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#icons02', { style: 'fade-down', speed: 375, intensity: 2, delay: 500, state: true, replay: true });
		onvisible.add('#columns01', { style: 'fade-in', speed: 250, intensity: 5, delay: 0, state: true, replay: true });
		onvisible.add('#container01', { style: 'fade-in', speed: 250, intensity: 5, delay: 250, state: true, replay: true });
		onvisible.add('#buttons03', { style: 'fade-in', speed: 125, intensity: 5, delay: 125, state: true, replay: true });
		onvisible.add('#columns02', { style: 'fade-in', speed: 250, intensity: 5, delay: 0, state: true, replay: true });
		onvisible.add('.buttons.style1', { style: 'fade-in', speed: 250, intensity: 5, delay: 125, state: true, replay: false });
		onvisible.add('#container02', { style: 'fade-in', speed: 250, intensity: 5, delay: 0, state: true, replay: true });
		onvisible.add('#buttons01', { style: 'fade-in', speed: 250, intensity: 5, delay: 125, state: true, replay: true });
		onvisible.add('#columns03', { style: 'fade-in', speed: 250, intensity: 5, delay: 0, state: true, replay: true });
